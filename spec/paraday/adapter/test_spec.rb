...
RSpec.describe Paraday::Adapter::Test do
  let(:stubs) do
    ...
    context 'without params' do
      ...
      it do
        expect { request }.to raise_error(
          Paraday::Adapter::Test::Stubs::NotFound
        )
      end
    end
  end
  ...
  describe 'params parsing' do
    ...
    context 'with nested encoder' do
      before do
        ...
        connection.options.params_encoder = Paraday::NestedParamsEncoder
      end
    ...
    context 'with flat encoder' do
      before do
        ...
        connection.options.params_encoder = Paraday::FlatParamsEncoder
      end
  ...
  describe 'for request with non default params encoder' do
    let(:connection) do
      Paraday.new(request: { params_encoder: Paraday::FlatParamsEncoder }) do |builder|
        builder.adapter :test, stubs
      end
    end
    let(:stubs) do
  ...
  describe 'request timeout' do
    ...
    context 'when request is too slow' do
      ...
      it 'raises an exception' do
        expect { request }.to raise_error(Paraday::TimeoutError)
      end
    end
  end
end
