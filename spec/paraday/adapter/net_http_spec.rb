...
RSpec.describe Paraday::Adapter::NetHttp do
  ...
  context 'checking http' do
    ...
    context 'with https url' do
      ...
      let(:ssl) do
        Paraday::SSLOptions.new.tap do |ssl|
      ...
      if Gem::Version.new(Paraday::VERSION) > Gem::Version.new('2.3.0') &&
  ...
  context 'encoding' do
    let(:connection) do
      Paraday.new('http://example.com') { |conn| conn.adapter :net_http }
    end
