...
RSpec.describe Paraday::Utils do
  describe 'headers parsing' do
    ...
    it 'parse headers for aggregated responses' do
      headers = Paraday::Utils::Headers.new
  ...
  describe 'URI parsing' do
    ...
    it 'escapes safe buffer' do
      ...
      expect(Paraday::Utils.escape(str)).to eq('%2432%2C000.00')
    end
    ...
    it 'replaces headers hash' do
      headers = Paraday::Utils::Headers.new('authorization' => 't0ps3cr3t!')
  ...
  describe '.deep_merge!' do
    let(:connection_options) { Paraday::ConnectionOptions.new }
    let(:url) do
      {
    ...
    it 'recursively merges the headers' do
      ...
      deep_merge = Paraday::Utils.deep_merge!(connection_options, url)
