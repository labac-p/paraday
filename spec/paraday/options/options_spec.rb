...
RSpec.describe Paraday::Options do
  SubOptions = Class.new(Paraday::Options.new(:sub_a, :sub_b))
  ParentOptions = Paraday::Options.new(:a, :b, :c) do
    ...
    describe '#fetch' do
      ...
      context 'when the fetched key has no value' do
        ...
        it 'needs a default if key is missing' do
          expect { subject.fetch(:sub_a) }.to raise_error(Paraday::Options.fetch_error_class)
        end
      end
