...
RSpec.describe Paraday::Response do
  subject { Paraday::Response.new(env) }

  let(:env) do
    Paraday::Env.from(status: 404, body: 'yikes', url: Paraday::Utils.URI('https://lostisland.github.io/paraday'),
