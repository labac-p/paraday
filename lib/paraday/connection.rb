...
module Paraday
  ...
  # @example
  #
  #   conn = Paraday::Connection.new 'http://httpbingo.org'
  #
  ...
  class Connection
    ...
    # @return [Paraday::RackBuilder] Builder for this Connection.
    attr_reader :builder
    ...
    # Initializes a new Paraday::Connection.
    #
    ...
    #   end
    #
    # @yield [Paraday::Request] for further request customizations
    ...
    # Determine if this Paraday::Connection can make parallel requests.
    #
    # @return [Boolean]
    def in_parallel?
      !!@parallel_manager
    ...
    def set_basic_auth(user, password)
      header = Paraday::Utils.basic_header_from(user, password)
      headers[Paraday::Request::Authorization::KEY] = header
    end
    ...
    # Builds and runs the Paraday::Request.
    #
    ...
    # @param method [Symbol]
    #
    # @yield [Paraday::Request] if block given
    # @return [Paraday::Request]
    ...
    #
    # @param url [String, URI, nil]
    # @param params [Paraday::Utils::ParamsHash] A Paraday::Utils::ParamsHash to
    ...
    # Creates a duplicate of this Paraday::Connection.
    #
    # @api private
    #
    ...
    def proxy_from_env(url)
      return if Paraday.ignore_env_proxy
