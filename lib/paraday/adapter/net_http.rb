    ...
    class NetHttp < Paraday::Adapter
      ...
      def call(env)
        ...
        connection(env) do |http|
          ...
          raise Paraday::SSLError, e if defined?(OpenSSL) && e.is_a?(OpenSSL::SSL::SSLError)

          raise Paraday::ConnectionFailed, e
        end
        @app.call env
      rescue Timeout::Error, Errno::ETIMEDOUT => e
        raise Paraday::TimeoutError, e
      end
