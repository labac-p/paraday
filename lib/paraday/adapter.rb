...
module Paraday
  # Base class for all Paraday adapters. Adapters are
  # responsible for fulfilling a Paraday request.
  class Adapter
    ...
    #
    # @param env [Paraday::Env, Hash] The env object for a paraday request.
    #
