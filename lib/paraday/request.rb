...
module Paraday
  ...
  # @!attribute headers
  #   @return [Paraday::Utils::Headers] headers
  # @!attribute body
  #   @return [String] body
  # @!attribute options
...
require 'paraday/request/authorization'
require 'paraday/request/instrumentation'
require 'paraday/request/json'
require 'paraday/request/url_encoded'
