...
require 'paraday/options/request_options'
require 'paraday/options/ssl_options'
require 'paraday/options/proxy_options'
require 'paraday/options/connection_options'
require 'paraday/options/env'
