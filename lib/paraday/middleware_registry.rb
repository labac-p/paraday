...
module Paraday
  ...
  module MiddlewareRegistry
    ...
    #       # Middleware looked up by :foo returns Paraday::Whatever::Foo.
    ...
    # @raise [Paraday::Error] if given key is not registered
    #
    # @example
    #
    #   module Paraday
    ...
    #   end
    #
    #   Paraday::Middleware.lookup_middleware(:foo)
    #   # => Paraday::Whatever
    def lookup_middleware(key)
      load_middleware(key) ||
        raise(Paraday::Error, "#{key.inspect} is not registered on #{self}")
    end
