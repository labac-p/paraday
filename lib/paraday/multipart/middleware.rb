...
module Paraday
  module Multipart
    ...
    class Middleware < Paraday::Request::UrlEncoded
      ...
      def create_multipart(env, params)
        ...
        parts << Paraday::Multipart::Parts::EpiloguePart.new(boundary)

        body = Paraday::Multipart::CompositeReadIO.new(parts)
        env.request_headers[Paraday::Env::ContentLength] = body.length.to_s
        body
      end
      ...
      def part(boundary, key, value)
        if value.respond_to?(:to_part)
          ...
          Paraday::Multipart::Parts::Part.new(boundary, key, value)
        end
      end
