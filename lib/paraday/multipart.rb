...
module Paraday
  # Main Paraday::Multipart module.
  module Multipart
    Paraday::Request.register_middleware(multipart: Paraday::Multipart::Middleware)
  end

  # Aliases for Paraday v1, these are all deprecated and will be removed in v2 of this middleware
